...
import zhifubaodemo.PayResult;
import zhifubaodemo.SignUtils;
...
public class ChongZhiActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private ImageView backToChongZhi=null;
    ...
    backToChongZhi= (ImageView) findViewById(R.id.backToChongzhiActivity);
    ...
    public void onPay(View view) {
        switch (view.getId()) {
            ...
            case R.id.recharge7:
                ...
                break;
            case R.id.lianxi:
//                LoadUtils.toWebActivity(this, this, );
                break;
    ...
    public void initPopup() {
        ...
        TextView zhifubao = (TextView) contentView.findViewById(R.id.zhifubao);
        ...
        mPopupWindow.showAtLocation(backToChongZhi, Gravity.BOTTOM, 0, 0);
