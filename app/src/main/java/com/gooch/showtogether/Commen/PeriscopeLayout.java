package com.gooch.showtogether.Commen;
...
public class PeriscopeLayout extends RelativeLayout {
    ...
    private void init() {
        ...
        Drawable red = getResources().getDrawable(R.mipmap.heartred);
        Drawable yellow = getResources().getDrawable(R.mipmap.heartgreen);
        Drawable blue = getResources().getDrawable(R.mipmap.heartgray);
